...
@Component({
    selector: 'lib-signature-mail-en',
    standalone: true,
    template: `
            ...
            <tr>
                <td [style]="cellPadding">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" [style]="tableCollapse">
                        <tbody>
                            <tr>
                                <td [style]="titleStyle">Signature</td>
                            </tr>
                            <tr>
                                <td>
...
export class SignatureMailEnComponent {
        ...
        return rows.map((item: SignatureRow) => ({
            ...
            date:
                item.date || item.record_approval_time
                    ? new Date(item.date || item.record_approval_time || '').toLocaleDateString('en-US')
                    : '',
